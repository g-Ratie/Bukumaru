	...
	if (seriesId) {
		return (
                        <Badge
                                asChild
                                variant="outline"
                                className="max-w-full break-words whitespace-normal border-blue-200 bg-blue-50 text-blue-700 text-xs dark:border-blue-800 dark:bg-blue-900/20 dark:text-blue-300"
                        >
                                <a
